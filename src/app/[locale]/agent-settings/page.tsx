                  ...
                  <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                          <label className="block text-gray-300 text-sm mb-2">{t('dropdowns.primary_branch')}</label>
                          <select
                          ...
                          >
                            <option value="main">{t('dropdowns.main')}</option>
                            <option value="master">{t('dropdowns.master')}</option>
                            <option value="develop">{t('dropdowns.develop')}</option>
                            <option value="staging">{t('dropdowns.staging')}</option>
                          </select>
                        </div>
                      </div>
